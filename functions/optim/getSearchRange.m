function range = getSearchRange(params)
...
params.analysis.relativeGridStep = (2*sqrt(2*log(2)));
...
range.step = step;
step = ones(2,1)*step;
range.upper([1 2],:) = range.start([1 2],:) + step.*params.analysis.fmins.expandRange;
range.lower([1 2],:) = range.start([1 2],:) - step.*params.analysis.fmins.expandRange;
